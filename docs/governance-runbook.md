...
| `npm run repo:verify:full` | manual local container-parity path for intentional deep review | not a front-door default and not proof of trusted remote CI supply-chain closure by itself |
